...
CREATE TABLE `admin` (
  `id` int(10) UNSIGNED NOT NULL,
  `ac` text COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
INSERT INTO `admin` (`id`, `ac`, `pw`) VALUES
(1, 'admin', '1234'),
(3, 'john', '1111');
...
INSERT INTO `menu` (`id`, `text`, `url`, `sh`, `main`) VALUES
(1, '管理登入', '?do=login', 1, 0),
(2, '網站首頁', 'index.php', 1, 0),
(4, '更多內容', '?do=news', 1, 1),
(9, '更多內容', '?do=news', 1, 2),
(10, '更多內容2', '?do=news', 1, 1);
